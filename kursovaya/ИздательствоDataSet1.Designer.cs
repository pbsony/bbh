...
namespace kursovaya {
    ...
    public partial class ИздательствоDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ЗаявкаDataTable : global::System.Data.TypedTableBase<ЗаявкаRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ЗаявкаRow AddЗаявкаRow(int НомерЗаявки, string ФИО, string Телефон, string Ссылка) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ЗаявкаRow FindByНомерЗаявки(int НомерЗаявки) {
            ...
            private void InitClass() {
                ...
                this.columnСсылка.MaxLength = 100;
            }
        ...
        public partial class ЗаявкаRow : global::System.Data.DataRow {
            ...
            public int НомерЗаявки {
                get {
                    return ((int)(this[this.tableЗаявка.НомерЗаявкиColumn]));
                }
                set {
            ...
            public string ФИО {
                get {
                    return ((string)(this[this.tableЗаявка.ФИОColumn]));
                }
                set {
                    this[this.tableЗаявка.ФИОColumn] = value;
                }
            }
            ...
            public string Телефон {
                get {
                    return ((string)(this[this.tableЗаявка.ТелефонColumn]));
                }
                set {
                    this[this.tableЗаявка.ТелефонColumn] = value;
                }
            }
            ...
            public string Ссылка {
                get {
                    return ((string)(this[this.tableЗаявка.СсылкаColumn]));
                }
                set {
                    this[this.tableЗаявка.СсылкаColumn] = value;
                }
            }
        }
...
namespace kursovaya.ИздательствоDataSet1TableAdapters {
    ...
    public partial class ЗаявкаTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Заявка] WHERE (([НомерЗаявки] = @Original_НомерЗаявки) AND ([Ф" +
                "ИО] = @Original_ФИО) AND ([Телефон] = @Original_Телефон) AND ([Ссылка] = @Origin" +
                "al_Ссылка))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Ссылка", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Ссылка", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Заявка] ([НомерЗаявки], [ФИО], [Телефон], [Ссылка]) VALUES (@Н" +
                "омерЗаявки, @ФИО, @Телефон, @Ссылка);\r\nSELECT НомерЗаявки, ФИО, Телефон, Ссылка " +
                "FROM Заявка WHERE (НомерЗаявки = @НомерЗаявки)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Ссылка", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Ссылка", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Заявка] SET [НомерЗаявки] = @НомерЗаявки, [ФИО] = @ФИО, [Телефон] = @Телефон, [Ссылка] = @Ссылка WHERE (([НомерЗаявки] = @Original_НомерЗаявки) AND ([ФИО] = @Original_ФИО) AND ([Телефон] = @Original_Телефон) AND ([Ссылка] = @Original_Ссылка));
SELECT НомерЗаявки, ФИО, Телефон, Ссылка FROM Заявка WHERE (НомерЗаявки = @НомерЗаявки)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Ссылка", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Ссылка", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Ссылка", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Ссылка", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT НомерЗаявки, ФИО, Телефон, Ссылка FROM dbo.Заявка";
        ...
        public virtual int Fill(ИздательствоDataSet1.ЗаявкаDataTable dataTable) {
        ...
        public virtual ИздательствоDataSet1.ЗаявкаDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ИздательствоDataSet1.ЗаявкаDataTable dataTable = new ИздательствоDataSet1.ЗаявкаDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ИздательствоDataSet1.ЗаявкаDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ИздательствоDataSet1 dataSet) {
        ...
        public virtual int Delete(int Original_НомерЗаявки, string Original_ФИО, string Original_Телефон, string Original_Ссылка) {
            ...
            if ((Original_Ссылка == null)) {
                throw new global::System.ArgumentNullException("Original_Ссылка");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_Ссылка));
            }
        ...
        public virtual int Insert(int НомерЗаявки, string ФИО, string Телефон, string Ссылка) {
            ...
            if ((Ссылка == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(Ссылка));
            }
        ...
        public virtual int Update(int НомерЗаявки, string ФИО, string Телефон, string Ссылка, int Original_НомерЗаявки, string Original_ФИО, string Original_Телефон, string Original_Ссылка) {
            ...
            if ((Ссылка == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Ссылка));
            }
            ...
            if ((Original_Ссылка == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Ссылка));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ФИО, string Телефон, string Ссылка, int Original_НомерЗаявки, string Original_ФИО, string Original_Телефон, string Original_Ссылка) {
            return this.Update(Original_НомерЗаявки, ФИО, Телефон, Ссылка, Original_НомерЗаявки, Original_ФИО, Original_Телефон, Original_Ссылка);
        }
    }
